...
mod tokio_utils {
    ...
    struct CopyBuffer {
        ...
        /// each fully-written datagram before reading the next one. Relies on the reader yielding at
        /// most one datagram per `poll_read` (as the UDP `StreamReader` does). See hoprnet#8421.
        datagram: bool,
        pos: usize,
        cap: usize,
        amt: u64,
